...
class StrengthLevelPage extends StatelessWidget {
  const StrengthLevelPage({super.key});

  static const List<Map<String, dynamic>> levels = [
    {
      'title': 'Beginner',
      'subtitle':
          'New to calisthenic? Start with foundational strength workouts',
      'icon': Icons.flag_outlined,
      'image': 'assets/images/workout1.jpg',
    },
    {
      'title': 'Easy',
      'subtitle': 'Gradual progression for building muscles strength',
      'icon': Icons.terrain,
      'image': 'assets/images/workout2.jpg',
    },
    {
      'title': 'Intermediate',
      'subtitle': 'Maximize your muscles strength',
      'icon': Icons.trending_up,
      'image': 'assets/images/workout3.jpg',
    },
    {
      'title': 'Advanced',
      'subtitle': 'Elite-level strength workouts challenges',
      'icon': Icons.bolt,
