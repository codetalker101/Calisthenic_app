      ...
      builder: (ctx) => Theme(
        data: Theme.of(context).copyWith(
          textSelectionTheme: const TextSelectionThemeData(
            cursorColor: Color(0xFF9B2354), // Cursor color
            selectionColor: Color(0xFF9B2354), // Highlight color
            selectionHandleColor: Color(0xFFECE6EF), // Drag handles color
          ),
        ),
        child: AlertDialog(
          ...
          content: TextField(
            ...
            style: const TextStyle(
              color: Colors.black, // ✅ Number/text color black
            ),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
          color: Colors.black, // backbutton color (top left screen)
        ),
        title: Row(
...
class _ProfileRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: onTap, // make editable if onTap is provided
      child: Padding(
