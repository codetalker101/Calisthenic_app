...
import 'package:calisthenics_app/features/profile/profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildWorkouts(double screenWidth, double screenHeight) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Padding(
  ...
  Widget _buildMeals(double screenWidth, double screenHeight) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Padding(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _buildWorkouts(screenWidth, screenHeight),
            const SizedBox(height: 10),
            _buildMeals(screenWidth, screenHeight),
          ],
        ),
      ),
    );
